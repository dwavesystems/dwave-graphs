...
from dwave.graphs.topologies.common import (
    EdgeKind, NodeKind, QUOTIENT, INFINITE,)
from dwave.graphs.topologies.zephyr import (ZephyrPlaneShift, ZephyrEdge, ZephyrNode, ZephyrCartesianCoord, ZephyrShape,
                                            ZephyrCoord,)
...
class TestZephyrEdge(unittest.TestCase):
    ...
    @parameterized.expand(
        [
            (ZephyrCoord(0, 10, 3, 1, 3), ZephyrCoord(
                0, 10, 3, 1, 2), ZephyrShape(6, 4)),
    ...
    @parameterized.expand(
        [
            ((2, 4), AttributeError),
            ((ZephyrNode(coord=ZephyrCartesianCoord(4, 3, 2), shape=(6, 3)), ZephyrNode(
                coord=ZephyrCartesianCoord(4, 3, 2), shape=(6, 3))), ValueError),
        ]
    )
...
class TestZephyrNode(unittest.TestCase):
    def setUp(self):
        ...
        self.left_up_xyms = [((0, 3), 6), ((0, 3), INFINITE),
                             ((11, 0), INFINITE), ((0, 5), 8)]
    ...
    @parameterized.expand(
        [
            (ZephyrNode((5, 2), ZephyrShape(6)), ZephyrPlaneShift(-2, -2),
             ZephyrNode((3, 0), ZephyrShape(6))),
            (ZephyrNode((5, 2), ZephyrShape(6)), ZephyrPlaneShift(
                2, -2), ZephyrNode((7, 0), ZephyrShape(6))),
            (ZephyrNode((5, 2), ZephyrShape(6)), ZephyrPlaneShift(
                2, 2), ZephyrNode((7, 4), ZephyrShape(6))),
            (ZephyrNode((5, 2), ZephyrShape(6)), ZephyrPlaneShift(-2, 2),
             ZephyrNode((3, 4), ZephyrShape(6))),
            (ZephyrNode((5, 4), ZephyrShape(4)), ZephyrPlaneShift(-4, -4),
             ZephyrNode((1, 0), ZephyrShape(4))),
            (ZephyrNode((6, 7), ZephyrShape(5)), ZephyrPlaneShift(
                1, 11), ZephyrNode((7, 18), ZephyrShape(5))),
            (ZephyrNode((0, 3), ZephyrShape(6)), ZephyrPlaneShift(
                0, 0), ZephyrNode((0, 3), ZephyrShape(6))),
            (ZephyrNode((1, 12), ZephyrShape(3)), ZephyrPlaneShift(
                1, -1), ZephyrNode((2, 11), ZephyrShape(3))),
        ]
    )
    ...
    def test_neighbors_boundary(self) -> None:
        ...
        expected_nbrs |= {ZephyrNode(
            (x + 2, y, k), ZephyrShape(t=t)), ZephyrNode((x + 4, y, k), ZephyrShape(t=t))}
        self.assertEqual(
            set(ZephyrNode((x, y, k), ZephyrShape(t=t)).neighbors()), expected_nbrs)
    ...
    def test_neighbors_mid(self):
        ...
        expected_nbrs |= {ZephyrNode(
            (x, y + 4, k), ZephyrShape(t=t)), ZephyrNode((x, y - 4, k), ZephyrShape(t=t))}
        expected_nbrs |= {ZephyrNode(
            (x, y + 2, k), ZephyrShape(t=t)), ZephyrNode((x, y - 2, k), ZephyrShape(t=t))}
        self.assertEqual(
            set(ZephyrNode((x, y, k), ZephyrShape(t=t)).neighbors()), expected_nbrs)

    def test_zcoord(self) -> None:
        ZephyrNode((11, 12, 4), ZephyrShape(t=6)
                   ).zcoord == ZephyrCoord(1, 0, 4, 0, 2)
    ...
    @parameterized.expand(
        [
            ...
            (ZephyrNode((0, 1, 2), ZephyrShape(t=4)), {
             ZephyrNode((0, 5, 2), ZephyrShape(t=4))}),
            (
                ZephyrNode((11, 6, 3), ZephyrShape(t=4)),
                {ZephyrNode((7, 6, 3), ZephyrShape(t=4)),
                 ZephyrNode((15, 6, 3), ZephyrShape(t=4))},
            ),
        ]
    )
    ...
    @parameterized.expand(
        [
            ...
            (ZephyrNode((0, 1, 2), ZephyrShape(t=4)), {
             ZephyrNode((0, 3, 2), ZephyrShape(t=4))}),
